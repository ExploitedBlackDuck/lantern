...
Version of this document: **0.5** · Covers app version **2.1.0** · Revised across four review rounds plus the five-horizon 2.0 build, all live-verified on NC 34 (see §0.1 and CHANGELOG).
...
| Current release | v2.1.0 — local + Files + GitHub + GitLab repositories, read-only |
