...
Version of this document: **0.6** · Covers app version **2.3.0** · Revised across four review rounds plus the five-horizon 2.0 build and the 2.3 hardening pass, all live-verified on NC 34 (see §0.1 and CHANGELOG).
...
| Current release | v2.3.0 — hardening pass (LFS pointers + submodules, short-TTL caching, i18n scaffolding, a11y AA in light + dark) atop local + Files + GitHub + GitLab; commit-range diffs + cross-repo search; UI/IA cleanup + full-width fill |
